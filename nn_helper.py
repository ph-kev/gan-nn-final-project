...
# Additional resources used that were helpful for making NN architecture: 
# https://pytorch.org/tutorials/beginner/dcgan_faces_tutorial.html
# Machine Learnign with PyTorch and Scikit-Learn by Sebastian Raschka et al.
...
# All loss functions are adjusted so that the optimizer need to minimize and not maximize 
